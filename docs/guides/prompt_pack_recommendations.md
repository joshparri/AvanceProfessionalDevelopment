...
This document captures the prompt pack recommendations and product enhancement ideas for both Avance apps, based on the live dashboard experience and the current app structure. For the detailed implementation backlog, see `docs/implementation-plans/two-app-prompt-pack-roadmap.md`.
...
1. **Codex/VS Code prompt - Rename and improve the dashboard title**
...
- Use the app's existing health and learning sections to surface coaching suggestions.

## App 2 - Avance PD (`avance-professional-development.vercel.app`)

### Key prompt pack opportunities

1. **Codex/VS Code prompt - Fix page title and branding**
...
- Use the PD Focus and Next Best Move cards to guide daily planning.
...
- Use `docs/implementation-plans/two-app-prompt-pack-roadmap.md` as the detailed build backlog.
